...
useGSAP(()=>{
    gsap.from(name.current,{opacity:0, stagger:0.2,ease:"elastic.inOut",duration:1,scrollTrigger:{trigger:name.current}})
})
    
    return(
        <div ref={scroll} id="helo" className="hero-section min-h-screen flex flex-col justify-center px-4 md:px-8 lg:px-12">
                ...
                <div className="flex flex-col lg:flex-row font-serif justify-center lg:justify-evenly items-center gap-8 md:gap-12 mt-6">
                    ...
                    <div className="text-center lg:text-left text-2xl md:text-3xl lg:text-4xl max-w-lg lg:max-w-2xl">
                        ...
                        <div  className="mb-4">I Am <span ref={name}><span  className="text-[#ff4b2b]">J</span>igyansu Das</span> </div>
